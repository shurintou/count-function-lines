...
export const javaFuncCounterHandler = function (filePath) {
    ...
    return javaFuncCounter(fileContent, minLineCount, maxLineCount, excludeFunctionNames)
}
 ...
 * @returns {FunctionLineCountsResult[]} 
 */
export const javaFuncCounter = function (fileContent, minLineCount = 0, maxLineCount = Infinity, excludeFunctionNames = []) {
